    ...
    var body: some View {
            ...
            ZStack {
                ...
                VStack(spacing: 5) {
                    ...
                    Text("\(wetterviewModel.wetterDaten.count)")
                        .foregroundColor(.white)
                    /*
                        List {
                            ForEach(wetterviewModel.wetterDaten) { wetterDatum in
                                NavigationLink {
                                    WetterDetailView(wetterDatum: wetterDatum)
                                } label: {
                                    WetterSmallView(wetterDatum: wetterDatum)
                                }
                            }
                            .onDelete(perform: wetterviewModel.deleteWetterDatum)
                        }
                        .onAppear{wetterviewModel.fetchWetterDatum("HAFENSTRASSE")
