...
class NrPokalViewModel: ObservableObject {
    ...
    init() {
        ...
        let spiel3 = SpielplanModel(teamNameHome: "SCHWARZ-WEISS ESSEN ", teamNameAway: "ROT-WEISS ESSEN ", ergebnis: " 5 : 7 n.E. ", teamLogoHome: "etbsp", teamLogoAway: "rwetabelle 1", spieltag: "ACHTELFINALE ", datum: "25. OKT. 2022 ", uhrzeit: "19 UHR ")
