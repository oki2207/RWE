...
class TabelleViewModel: ObservableObject {
    ...
    init() {
        ...
        let team2 = TabelleModel(teamName: " SC FREIBURG II ", punkte: 64, tore: 6, gegentore: 5, spiele: 34, platz: 2, differenz: 17, logo: "freiburglogotabelle")
        let team3 = TabelleModel(teamName: " WEHEN-WIESBADEN ", punkte: 63, tore: 4, gegentore: 3, spiele: 34, platz: 3, differenz: 20, logo: "wehenlogotabelle")
        ...
        let team9 = TabelleModel(teamName: " TSV 1860 MÜNCHEN ", punkte: 49, tore: 3, gegentore: 2, spiele: 34, platz: 9, differenz: 6, logo: "1860logo")
        let team10 = TabelleModel(teamName: " SC VERL ", punkte: 48, tore: 2, gegentore: 9, spiele: 34, platz: 10, differenz: 5, logo: "verllogo")
        let team11 = TabelleModel(teamName: " FC ERZGEBIRGE AUE (A) ", punkte: 43, tore: 5, gegentore: 3, spiele: 34, platz: 11, differenz: -7, logo: "auelogoneu")
