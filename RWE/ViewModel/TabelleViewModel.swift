...
class TabelleViewModel: ObservableObject {
    ...
    init() {
        let team1 = TabelleModel(teamName: "SV Elversberg", punkte: 67, tore: 5, gegentore: 3, spiele: 34, platz: 1, differenz: 37, logo: "elvlogotabelle")
        ...
        let team4 = TabelleModel(teamName: "Dynamo Dresden", punkte: 60, tore: 3, gegentore: 2, spiele: 34, platz: 4, differenz: 20, logo: "dynamologotabelle")
        ...
        let team17 = TabelleModel(teamName: "VfB Oldenburg", punkte: 32, tore: 6, gegentore: 5, spiele: 34, platz: 17, differenz: -21, logo: "oldelogo")
        let team18 = TabelleModel(teamName: "SpVgg Bayreuth", punkte: 31, tore: 4, gegentore: 3, spiele: 34, platz: 18, differenz: -35, logo: "baylogo")
